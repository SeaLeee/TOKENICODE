...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'notification.permissionNeeded': '需要你批准操作',
    ...
    'input.addSkillTitle': '添加 Skill 到输入框',
    'input.attachedCount': '已附加 {count} 项',
    'input.skillDirective': '请调用 {names} 技能来完成以下任务',
    'input.skillSuggestLabel': '建议',
    'input.skillSuggestLoading': 'AI 判断中…',
    'msg.attachedSkills': '已附加 Skill',
    'msg.usedSkills': '已使用 Skill',
    'input.openFile': '在编辑器中打开',
    'input.revealFile': '在资源管理器中显示',
    'input.openProjectFolder': '打开项目文件夹',
    'input.openProjectInVscode': '在 VS Code 中打开项目',
    ...
    'model.nativeLabel': '跟随 Claude Code 配置',
    'model.nativeDefault': '默认模型',
    ...
    'storyboard.shot': '镜号',
    'storyboard.image': '成图',
    'storyboard.timecode': '时间码',
    'storyboard.shotSize': '景别',
    'storyboard.description': '画面描述',
    'storyboard.title': '镜头标题',
    'storyboard.pasteHint': '选中镜头后 Ctrl+V 粘贴图片',
    'storyboard.undo': '撤销',
    'storyboard.redo': '重做',
    'storyboard.savingImage': '正在保存图片...',
    'storyboard.imageSaved': '图片已保存到资源图片文件夹',
    'storyboard.imageSaveFailed': '图片保存失败',
    'storyboard.shots': '个镜头',
    'storyboard.compact': '精简',
    'storyboard.full': '完整',
    'storyboard.fullContent': '完整内容',
    'storyboard.mark': '重点标记',
    'storyboard.mark.none': '无标记',
    'storyboard.mark.red': '红色重点',
    'storyboard.mark.amber': '黄色重点',
    'storyboard.mark.green': '绿色重点',
    'storyboard.mark.blue': '蓝色重点',
    'storyboard.chooseImages': '选择一张或多张分镜图片',
    'storyboard.addImages': '添加图片',
    'storyboard.removeImage': '移除图片引用',
    'storyboard.pathPlaceholder': '输入图片文件路径；多条用分号分隔',
    'storyboard.import': '导入',
    'storyboard.copyPrompt': '复制提示词',
    'storyboard.copied': '已复制',
    'storyboard.copyFailed': '复制失败',
    ...
    'settings.skillSuggestTitle': 'Skill 建议',
    'settings.skillAutoSuggest': '自动选择 Skill',
    'settings.skillAutoSuggestHint': '根据对话内容自动推荐可能用到的 Skill，并在输入框中询问是否使用',
    'settings.skillAutoAttach': '自动附加建议的 Skill',
    'settings.skillAutoAttachHint': '提交时自动附加评分最高的 Skill',
    'settings.skillAiEnhance': 'AI 语义判断 Skill',
    'settings.skillAiEnhanceHint': '用激活的提供商模型做语义匹配（会产生少量 token 费用）',
    ...
    'provider.pricingInput': '输入 $/M',
    'provider.pricingOutput': '输出 $/M',
    'provider.pricingHint': '可选：为非 Claude 模型设置价格（美元/百万 token），用于准确统计费用。留空则用内置默认价（如 DeepSeek）。',
    ...
    // Command feedback
    'cmd.switchedToAsk': '已切换到手动模式（每次操作都需确认）',
    'cmd.switchedToPlan': '已切换到计划模式（规划任务，不直接执行）',
    'cmd.switchedToAuto': '已切换到自动模式（跳过所有权限检查）',
    'cmd.switchedToEditAuto': '已切换到编辑自动模式（自动接受文件编辑，危险命令仍需确认）',
    ...
    'skillPicker.empty': '暂无已安装的 Skill，可到「技能」面板的广场安装',
    'skillPicker.frequent': '常用',
    'skillPicker.recent': '最近下载',
    'skillPicker.uncategorized': '其他',
    ...
    'skills.marketplace': '广场',
    'skills.favorites': '收藏',
    'skills.frequent': '常用',
    'skills.mine': '我的技能',
    'skills.addFolder': '添加技能文件夹',
    'skills.addFolderHint': '扫描该文件夹下的所有技能（自定义技能优先级更高）',
    'skills.removeFolder': '移除此文件夹',
    'skills.customFolders': '自定义技能文件夹',
    'skills.importSuccess': '已自动安装 {names} 技能',
    'skills.importFailed': '自动安装技能失败',
    'skillCategory.film': '影视',
    'skillCategory.writing': '写作文案',
    'skillCategory.coding': '编程开发',
    'skillCategory.design': '设计',
    'skillCategory.data': '数据分析',
    'skillCategory.marketing': '营销运营',
    'skillCategory.music': '音乐音频',
    'skillCategory.image': '图像绘画',
    'skillCategory.office': '办公效率',
    'skillCategory.business': '商业管理',
    'skillCategory.security': '安全',
    'skillCategory.other': '其他',
    'skills.addFavorite': '收藏此技能',
    'skills.removeFavorite': '取消收藏',
    'skills.rating': '评分',
    'skills.category': '类别',
    'skills.tags': '标签',
    'skills.addTag': '添加标签，回车确认',
    'skills.removeTag': '移除标签',
    'skills.detail': '技能详情',
    'skills.detailClose': '关闭',
    'skills.detailOpenEditor': '在编辑器中打开',
    'marketplace.title': 'Skill 广场',
    'marketplace.search': '搜索 Skill...',
    'marketplace.install': '安装',
    'marketplace.installed': '已安装',
    'marketplace.installing': '安装中...',
    'marketplace.downloads': '下载',
    'marketplace.score': '评分',
    'marketplace.verified': '已验证',
    'marketplace.empty': '未找到匹配的 Skill',
    'marketplace.error': '加载失败，请重试',
    'marketplace.sort.score': '按评分',
    'marketplace.sort.downloads': '按下载量',
    'marketplace.sort.trending': '按热度',
    'marketplace.requiresApiKey': '需 API Key',
    'marketplace.use': '使用',
    'marketplace.useSuccess': '已加入输入框，输入内容后发送即可调用该 Skill',
    'marketplace.installSuccess': '已安装到 ~/.claude/skills/{slug}，新会话生效',
    ...
    'mcp.url': 'URL',
    'mcp.urlPlaceholder': '输入 MCP 服务器 URL，如 https://ai-game.dev/mcp',
    'mcp.refresh': '刷新',
    'mcp.envCount': '个环境变量',
  ...
  en: {
    ...
    'notification.permissionNeeded': 'Approval needed',
    ...
    'input.addSkill': 'Skill',
    'input.addSkillTitle': 'Add a skill to the input',
    'input.attachedCount': '{count} attached',
    'input.skillDirective': 'Use the {names} skill to complete the following task',
    'input.skillSuggestLabel': 'Suggest',
    'input.skillSuggestLoading': 'Thinking…',
    'msg.attachedSkills': 'Attached skills',
    'msg.usedSkills': 'Skills used',
    'input.openFile': 'Open in editor',
    'input.revealFile': 'Reveal in file manager',
    'input.openProjectFolder': 'Open project folder',
    'input.openProjectInVscode': 'Open project in VS Code',
    ...
    'model.nativeLabel': 'Follow Claude Code config',
    'model.nativeDefault': 'Default model',
    ...
    'files.openFolder': 'Open containing folder',
    ...
    'storyboard.timecode': 'Timecode',
    'storyboard.shotSize': 'Shot size',
    'storyboard.description': 'Description',
    'storyboard.title': 'Shot title',
    'storyboard.pasteHint': 'Select a shot, then paste an image',
    'storyboard.undo': 'Undo',
    'storyboard.redo': 'Redo',
    'storyboard.savingImage': 'Saving image...',
    'storyboard.imageSaved': 'Image saved in the asset folder',
    'storyboard.imageSaveFailed': 'Failed to save image',
    'storyboard.shots': 'shots',
    'storyboard.compact': 'Compact',
    'storyboard.full': 'Full',
    'storyboard.fullContent': 'Full content',
    'storyboard.mark': 'Highlight',
    'storyboard.mark.none': 'No highlight',
    'storyboard.mark.red': 'Red highlight',
    'storyboard.mark.amber': 'Amber highlight',
    'storyboard.mark.green': 'Green highlight',
    'storyboard.mark.blue': 'Blue highlight',
    'storyboard.chooseImages': 'Choose one or more storyboard images',
    'storyboard.addImages': 'Add images',
    'storyboard.removeImage': 'Remove image reference',
    'storyboard.pathPlaceholder': 'Image paths; separate multiple paths with semicolons',
    'storyboard.import': 'Import',
    'storyboard.copyPrompt': 'Copy prompt',
    'storyboard.copied': 'Copied',
    'storyboard.copyFailed': 'Copy failed',
    ...
    'settings.skillSuggestTitle': 'Skill suggestions',
    'settings.skillAutoSuggest': 'Auto-select skills',
    'settings.skillAutoSuggestHint': 'Suggest relevant skills based on the conversation, and ask before using them',
    'settings.skillAutoAttach': 'Auto-attach suggested skill',
    'settings.skillAutoAttachHint': 'Auto-attach the top-scored skill on submit',
    'settings.skillAiEnhance': 'AI semantic skill matching',
    'settings.skillAiEnhanceHint': 'Use the active provider model for semantic matching (small token cost)',
    ...
    'provider.pricingInput': 'In $/M',
    'provider.pricingOutput': 'Out $/M',
    'provider.pricingHint': 'Optional: set the per-model price (USD per 1M tokens) for non-Claude models to compute accurate cost stats. Empty falls back to built-in defaults (e.g. DeepSeek).',
    ...
    // Command feedback
    'cmd.switchedToAsk': 'Switched to Manual mode (confirm every action)',
    'cmd.switchedToPlan': 'Switched to Plan mode (planning only, no execution)',
    'cmd.switchedToAuto': 'Switched to Auto mode (skip all permission checks)',
    'cmd.switchedToEditAuto': 'Switched to Edit Auto mode (auto-accept file edits, still confirms dangerous commands)',
    ...
    'skillPicker.empty': 'No installed skills — install one from the Skills panel marketplace',
    'skillPicker.frequent': 'Frequently used',
    'skillPicker.recent': 'Recently downloaded',
    'skillPicker.uncategorized': 'Other',
    ...
    'skills.frequent': 'Frequently used',
    'skills.mine': 'My skills',
    'skills.addFolder': 'Add skill folder',
    'skills.addFolderHint': 'Scan every skill under this folder (custom skills rank higher)',
    'skills.removeFolder': 'Remove this folder',
    'skills.customFolders': 'Custom skill folders',
    'skills.importSuccess': 'Auto-installed skills: {names}',
    'skills.importFailed': 'Failed to auto-install skills',
    'skillCategory.film': 'Film & Video',
    ...
    'skillCategory.music': 'Music & Audio',
    'skillCategory.image': 'Image',
    'skillCategory.office': 'Productivity',
    ...
    'skills.tags': 'Tags',
    'skills.addTag': 'Add a tag, press Enter',
    'skills.removeTag': 'Remove tag',
    'skills.detail': 'Skill details',
    'skills.detailClose': 'Close',
    'skills.detailOpenEditor': 'Open in editor',
    'marketplace.title': 'Skill Marketplace',
    ...
    'marketplace.score': 'score',
    'marketplace.verified': 'Verified',
    'marketplace.empty': 'No matching skills',
    'marketplace.error': 'Failed to load, please retry',
    'marketplace.sort.score': 'By score',
    'marketplace.sort.downloads': 'By downloads',
    'marketplace.sort.trending': 'Trending',
    'marketplace.requiresApiKey': 'API key required',
    'marketplace.use': 'Use',
    'marketplace.useSuccess': 'Added to the input — type and send to invoke the skill',
    'marketplace.installSuccess': 'Installed to ~/.claude/skills/{slug}, takes effect in a new session',
    ...
    'mcp.url': 'URL',
    'mcp.urlPlaceholder': 'Enter MCP server URL, e.g. https://ai-game.dev/mcp',
    'mcp.refresh': 'Refresh',
